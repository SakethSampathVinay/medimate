...
const TranslateTextInputSchema = z.object({
  ...
  targetLanguage: z.string().describe("The target language for translation (e.g., 'Telugu', 'Hindi')."),
});
...
const translatePrompt = ai.definePrompt({
  ...
  prompt: `Translate the following text into {{targetLanguage}}. Provide only the translated text as the output.
