  ...
  return (
    <AppLayout>
      <div className="space-y-8">
        ...
        <section>
          <h2 className="font-headline text-3xl font-semibold mb-6 text-foreground">Explore Features</h2>
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            {features.map((feature) => (
              <Card key={feature.title} className="flex flex-col overflow-hidden shadow-md hover:shadow-xl transition-shadow duration-300 dark:bg-card">
                ...
                <CardContent className="flex-grow flex items-end p-6 pt-0">
                  <Link href={feature.href} className="w-full">
                    <Button variant="outline" className="w-full group hover:bg-primary/10">
                      Explore <ArrowRight className="ml-2 h-4 w-4 text-primary group-hover:translate-x-1 transition-transform" />
                    </Button>
                  </Link>
                </CardContent>
              </Card>
        ...
        <section>
          <Card className="shadow-md dark:bg-card">
            <CardHeader>
              <CardTitle className="font-headline text-2xl text-card-foreground">Health Tip of the Day</CardTitle>
            </CardHeader>
            <CardContent>
